...
string_1 = input('enter a random string:')
char_1 = input('enter a char:')
#result_1 = 0
count = 0
index = 0
...
result_2 = 1
digit = 0
while digit < len(number_1):
    result_2 = result_2 * int(number_1[digit])
    digit = digit+1
print(result_2)
...
number_2 = "12345"
result_3 = " "
digit_1 = len(number_2) - 1
while digit_1 >= 0:
    result_3 = result_3 + number_2[digit_1]
    digit_1 = digit_1 - 1
print(result_3)
